...
class Calculator {
    ...
    compute() {
        ...
        // alert("x1: " + x1);
        // alert("x2: " + x2);
        // var newAnswer = x1.plus(x2).valueOf();
        ...
        switch (this.operation) {
            ...
            case '*':
                ...
                break
            case '÷':
                // if x2 = 0, then divide by 1 instead
                if (x2 == 0){
                    alert("Warning: Division By Zero Not Accepted.");
                    computation = x1;
                } /*else if (x2String == '.'){
                    alert("Warning: Division By Decimals Not Accepted.");
                    computation = x1;
                }*/ else {
                ...
                /*
                if (possibleAnswer.length < 6){
                    computation = possibleAnswer;
                    alert("computation (a): " + computation);
                } else {
                    if (possibleAnswer)
                    computation = "(" + x1 + "÷" + x2 + ")";
                    alert("computation (b): " + computation);
                }
                */
                break
            default:
