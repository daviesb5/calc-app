...
Version: big.js v5.2.2 https://github.com/MikeMcl/big.js/LICENCE
*/
...
/* Main "Special Function" for Calculator */
class Calculator {
    ...
    /* treats decimals separately from numbers */
    checkDecimal(decimal, currentOperandTextElement){

    }
    /* updates the displayed equations */
    updateDisplay(){
        // this
    }
}
...
decimalBtn.forEach(button => {
    button.addEventListener('click', () => {
        calculator.checkDecimal(button.innerText);
        calculator.updateDisplay();
    })
})
...
operationBtns.forEach(button => {
    button.addEventListener('click', () => {
        calculator.chooseOperation(button.innerText, currentOperandTextElement);
        calculator.updateDisplay();
    })
})